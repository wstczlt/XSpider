package com.test.deprecated;

import static com.test.Config.LOGGER;
import static com.test.deprecated.SpiderConfig.STATIC_ID_END;
import static com.test.deprecated.SpiderConfig.STATIC_ID_START;

import java.util.ArrayList;
import java.util.List;

import com.test.deprecated.tools.SpiderBuilder;
