...
import com.test.spider.ProxyProvider;
...
public class SpiderDownloader extends AbstractDownloader {
  ...
  public SpiderDownloader setProxyProvider(ProxyProvider proxyProvider) {
  ...
  public Page download(Request request, Task task) {
    ...
    Page page = Page.fail();
    try {
      response = httpClient.execute(requestContext.getHttpUriRequest(),
      ...
      System.out.println("Failed: => " + e.getMessage() + " => " + request.getUrl());
      onError(request);
      return page;
    } finally {
      if (response != null) {
