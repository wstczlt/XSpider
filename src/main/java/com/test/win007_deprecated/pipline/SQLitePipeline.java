package com.test.win007_deprecated.pipline;
...
import com.test.win007_deprecated.SpiderConfig;
...
public class SQLitePipeline implements Pipeline {
  ...
  private DataSource openDatabase() {
    return new DbHelper().open();
  }


  private boolean isExistTable() {
    try {
      QueryRunner runner = new QueryRunner(openDatabase());
  ...
  private void createTable() {
    try {
      ...
      // System.exit(0);
      final QueryRunner runner = new QueryRunner(openDatabase());
